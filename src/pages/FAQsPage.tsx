  ...
  return (
    <div className="w-[1100px] drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] rounded-[8px] overflow-hidden">
      <button
        ...
        className="w-full bg-[#00629b] min-h-[70px] h-auto py-5 flex items-center justify-between px-7 cursor-pointer"
      >
        <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[35px] text-left text-white tracking-[1.7px] uppercase flex-1 text-left pr-4">{question}</p>
        <Chevron open={open} />
      </button>
  ...
  return (
    <div className="bg-white min-w-[1440px] flex flex-col items-center">
      ...
      <div className="relative h-[400px] w-[1440px] overflow-hidden flex items-center justify-center">
        ...
        <p className="relative font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[80px] text-white tracking-[4.8px] uppercase text-center w-[880px]">FAQs</p>
      </div>
