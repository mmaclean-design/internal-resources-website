      ...
      {open && (
        <div className="bg-white p-4 flex flex-col gap-4">
          <div className="flex gap-4">
            ...
            <div className="bg-[#f5f0e6] flex-1 p-6 rounded-[8px]">
              <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[#1e1e1e] text-[24px] tracking-[1.2px] uppercase mb-4">Visiting Scholars and Research Staff Access</p>
              <ul className="font-['Source_Sans_Pro:Light',sans-serif] text-[#1e1e1e] text-[21px] list-disc pl-8 space-y-2">
          ...
          <div className="bg-[#f5f0e6] p-6 rounded-[8px]">
            ...
            <div className="flex justify-center">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSd87N57bpfJCcK5tKX82pt3Uh0c8Vo8DoCh-LC6hAR54N7DaA/viewform?usp=sharing" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
    ...
    <div className="w-[1100px] drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] rounded-[8px] overflow-hidden">
      ...
      {open && (
        <div className="bg-white p-4 flex gap-4">
          <div className="bg-[#f5f0e6] flex-1 p-6 rounded-[8px]">
            <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[#1e1e1e] text-[24px] tracking-[1.2px] uppercase mb-4">Space Standards</p>
            <div className="font-['Source_Sans_Pro:Light',sans-serif] text-[#1e1e1e] text-[21px] space-y-4 mb-6">
            ...
            <div className="flex justify-center">
              <button className="relative h-[44px] w-[343px]">
                <svg className="absolute inset-0 size-full" fill="none" height="44" preserveAspectRatio="none" viewBox="0 0 343 44" width="343">
                  <path d={btnPath} fill="#00629B" />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="bg-[#f5f0e6] flex-1 p-6 rounded-[8px]">
            <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[#1e1e1e] text-[24px] tracking-[1.2px] uppercase mb-4">Posting Policies</p>
            <div className="font-['Source_Sans_Pro:Light',sans-serif] text-[#1e1e1e] text-[21px] space-y-4 mb-6">
            ...
            <div className="flex justify-center">
              <a href="https://docs.google.com/document/d/1hDkawsiCSmUZG4NZ3R6ScbcNM9HIFQXKqTBE6k5BYko/edit?tab=t.0" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
                <svg className="absolute inset-0 size-full" fill="none" height="44" preserveAspectRatio="none" viewBox="0 0 343 44" width="343">
                  <path d={btnPath} fill="#00629B" />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
    ...
    <div className="w-[1100px] drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] rounded-[8px] overflow-hidden">
      ...
      {open && (
        <div className="bg-white flex flex-col gap-[5px] pt-[5px] pb-6">
          ...
          {/* Buttons */}
          <div className="flex mt-5 justify-center gap-x-[325px]">
            <a href="https://script.google.com/a/macros/ucsd.edu/s/AKfycbzVW_BijuR04t-ih6PLpcc5Uoe7yKxZSriucf4WRPb60USsKdkFrbDLx5AeRMY6xienTA/exec" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
              <svg className="absolute inset-0 size-full" fill="none" height="44" preserveAspectRatio="none" viewBox="0 0 343 44" width="343">
                <path d={btnPath} fill="#00629B" />
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
            ...
            <a href="https://script.google.com/a/macros/ucsd.edu/s/AKfycbxY8bRVzUsM1Sc5AZkzPahzNCeSguNEEf5VHK6zY18m0mnkD96aNfDJMJmI-4LKTCg/exec" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
              <svg className="absolute inset-0 size-full" fill="none" height="44" preserveAspectRatio="none" viewBox="0 0 343 44" width="343">
                <path d={btnPath} fill="#00629B" />
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
  ...
  return (
    <div className="bg-white min-w-[1440px] flex flex-col items-center">
      ...
      <div className="relative h-[400px] w-[1440px] overflow-hidden flex items-center justify-center">
        ...
        <p className="absolute font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[80px] text-white tracking-[4.8px] uppercase text-center w-[880px]">space resources</p>
      </div>

      {/* Dropdowns */}
      <div className="flex flex-col items-center gap-[38px] py-12 bg-white">
        <AccessInformation />
        <PoliciesDropdown />
