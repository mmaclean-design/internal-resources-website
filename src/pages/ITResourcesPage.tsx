...
function DropdownHeader({ title, open, onToggle }: { title: string; open: boolean; onToggle: () => void }) {
  return (
    <button
      onClick={onToggle}
      className="w-full bg-[#00629b] h-[70px] flex items-center justify-between px-7 cursor-pointer"
    >
      ...
      {open && (
        <div className="bg-white p-4">
          <div className="bg-[#f5f0e6] p-6 rounded-[8px]">
            <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-black text-[24px] tracking-[1.2px] uppercase mb-4">General IT Support</p>
            <p className="font-['Source_Sans_Pro:Light',sans-serif] text-black text-[21px] mb-8">
            ...
            <div className="flex justify-center">
              <a href="https://blink.ucsd.edu/technology/help-desk/index.html" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
    ...
    <div className="w-[1100px] drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] rounded-[8px] overflow-hidden">
      ...
      {open && (
        <div className="bg-white p-4 flex flex-col gap-4">
          <div className="bg-[#f5f0e6] p-6 rounded-[8px]">
            <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-black text-[24px] tracking-[1.2px] uppercase mb-4">General Policies</p>
          ...
          <div className="flex gap-4">
            <div className="bg-[#f5f0e6] flex-1 p-6 rounded-[8px]">
              <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-black text-[24px] tracking-[1.2px] uppercase mb-4">Connection for Mac</p>
              <ol className="font-['Source_Sans_Pro:Light',sans-serif] text-black text-[21px] list-decimal pl-8 space-y-2">
            ...
            <div className="bg-[#f5f0e6] flex-1 p-6 rounded-[8px]">
              <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-black text-[24px] tracking-[1.2px] uppercase mb-4">Connection for Windows</p>
              <ol className="font-['Source_Sans_Pro:Light',sans-serif] text-black text-[21px] list-decimal pl-8 space-y-2">
          ...
          <div className="bg-[#f5f0e6] p-6 rounded-[8px]">
            <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-black text-[24px] tracking-[1.2px] uppercase mb-4">Printer Name</p>
            <p className="font-['Source_Sans_Pro:Light',sans-serif] text-black text-[21px]">HP Color LaserJet Enterprise MFP M681 (dlab-hp-mfpm681)</p>
            <p className="font-['Source_Sans_Pro:Light',sans-serif] text-black text-[21px]">IP address: 192.168.0.171</p>
          </div>
        </div>
      )}
    </div>
    ...
    <div className="w-[1100px] drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] rounded-[8px] overflow-hidden">
      ...
      {open && (
        <div className="bg-white p-4 flex flex-col gap-4">
          ...
          <div className="bg-[#f5f0e6] p-6 rounded-[8px]">
            <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-black text-[24px] tracking-[1.2px] uppercase mb-4">Step 2: Register Device(s) for Ethernet/Wired Connection</p>
            <p className="font-['Source_Sans_Pro:Light',sans-serif] text-black text-[21px] mb-6">
              Please refer to the Office of Engineering Computing (OEC) directions for establishing network connections at UC San Diego.
            </p>
            <div className="flex justify-center">
              <a href="https://support.eng.ucsd.edu/how-to-guides/network" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
                <svg className="absolute inset-0 size-full" fill="none" height="44" preserveAspectRatio="none" viewBox="0 0 343 44" width="343">
                  <path d={btnPath} fill="#00629B" />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
  ...
  return (
    <div className="bg-white min-w-[1440px] flex flex-col">
      ...
      <div className="relative h-[400px] w-[1440px] overflow-hidden flex items-center justify-center">
        ...
        <p className="absolute font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[80px] text-white tracking-[4.8px] uppercase text-center w-[880px]">IT Resources</p>
      </div>

      {/* Dropdowns */}
      <div className="flex flex-col items-center gap-[64px] py-12 bg-white">
        <ItSupportDropdown />
        <PrinterDropdown />
        <EthernetDropdown />
      </div>
