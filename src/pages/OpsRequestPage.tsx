...
function OpsEventSupportDropdown() {
  ...
  return (
    <div className="w-[1100px] drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] rounded-[8px] overflow-hidden">
      ...
      >
        <p className="font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[35px] text-left text-white tracking-[1.7px] uppercase">Operations Event Support</p>
        <Chevron open={open} />
      </button>
      {open && (
        <div className="bg-white p-4 flex gap-4">
          ...
          <div className="bg-[#f5f0e6] p-6 flex items-center justify-center w-[400px] rounded-[8px]">
            <a href="https://forms.gle/oU2Xx2kkzgMyYqdB8" target="_blank" rel="noreferrer" className="relative h-[44px] w-[343px]">
  ...
  return (
    <div className="bg-white min-w-[1440px] min-h-screen flex flex-col items-center">
      ...
      <div className="relative h-[400px] w-[1440px] overflow-hidden flex items-center justify-center">
        ...
        <p className="absolute font-['Refrigerator_Deluxe:ExtraBold',sans-serif] text-[80px] text-white tracking-[4.8px] uppercase text-center w-[880px]">ops request form</p>
      </div>
