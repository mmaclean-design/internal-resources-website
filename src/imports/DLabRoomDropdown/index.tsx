import svgPaths from "./svg-issewheolm";
...
export default function DLabRoomDropdown({ className, property1 = "Default" }: DLabRoomDropdownProps) {
  ...
  return (
    <button className={className || `block drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] relative w-[1300px] ${isVariant2 ? "h-[722px]" : "h-[110px]"}`}>
      {isDefault && (
        <>
      ...
      {isVariant2 && (
        <>
          ...
          <div className="absolute contents left-0 top-[358px]">
            <div className="absolute bg-[#f5f0e6] h-[300px] left-0 top-[358px] w-[633px]" />
            <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Source_Sans_Pro:SemiBold',sans-serif] h-[45.683px] justify-center leading-[0] left-[311.86px] not-italic text-[#182b49] text-[21.248px] text-center top-[507.84px] tracking-[1.0624px] w-[233.728px]">
              <p className="leading-[normal]">311</p>
            </div>
          </div>
          <div className="absolute contents left-[667px] top-[358px]">
            <div className="absolute bg-[#f5f0e6] h-[300px] left-[667px] top-[358px] w-[633px]" />
            <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Source_Sans_Pro:SemiBold',sans-serif] h-[45.683px] justify-center leading-[0] left-[983.86px] not-italic text-[#182b49] text-[21.248px] text-center top-[499.84px] tracking-[1.0624px] w-[233.728px]">
              <p className="leading-[normal]">361</p>
            </div>
          </div>
          <div className="absolute contents left-[145px] top-[678px]" data-name="Button">
            <div className="absolute h-[44px] left-[145px] top-[678px] w-[343px]">
            ...
            <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Source_Sans_Pro:Bold',sans-serif] h-[13px] justify-center leading-[0] left-[314px] not-italic text-[20px] text-center text-white top-[700px] tracking-[1px] uppercase w-[320px]">
              <p className="leading-[normal]">Reserve Room</p>
            </div>
          </div>
          <div className="absolute contents left-[812px] top-[678px]" data-name="Button">
            <div className="absolute h-[44px] left-[812px] top-[678px] w-[343px]">
              <svg className="absolute block inset-0 size-full" fill="none" height="44" preserveAspectRatio="none" viewBox="0 0 343 44" width="343">
                <path d={svgPaths.peab5080} fill="#00629B" id="Rectangle 33" />
              </svg>
            </div>
            <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Source_Sans_Pro:Bold',sans-serif] h-[13px] justify-center leading-[0] left-[981px] not-italic text-[20px] text-center text-white top-[700px] tracking-[1px] uppercase w-[320px]">
              <p className="leading-[normal]">Reserve Room</p>
            </div>
          </div>
        </>
