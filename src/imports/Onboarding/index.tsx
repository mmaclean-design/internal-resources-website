...
function UsefulLinks({ className, property1 = "Default" }: UsefulLinksProps) {
  const isDefault = property1 === "Default";
  const isVariant2 = property1 === "Variant2";
  return (
    <button className={className || `block drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] relative w-[1300px] ${isVariant2 ? "h-[455px]" : "h-[110px]"}`}>
      {isDefault && (
        <>
          <div className="absolute bg-[#00629b] inset-[27.27%_0_0_0]" />
          <p className="[word-break:break-word] absolute font-['Refrigerator_Deluxe:ExtraBold',sans-serif] inset-[44.55%_50.13%_17%_2.23%] leading-[normal] not-italic text-[38.173px] text-left text-white tracking-[1.9086px] uppercase">Useful Links</p>
      ...
      {isVariant2 && (
        <>
          <div className="absolute contents left-0 top-[30px]" data-name="DLab Room Dropdown">
            ...
            <p className="[word-break:break-word] absolute font-['Refrigerator_Deluxe:ExtraBold',sans-serif] h-[42.298px] leading-[normal] left-[29px] not-italic text-[38.173px] text-left text-white top-[49px] tracking-[1.9086px] uppercase w-[619.25px]">Useful Links</p>
            <div className="absolute flex h-[27px] items-center justify-center left-[1230px] top-[69px] w-[104.713px]">
          ...
          <div className="absolute bg-[#d9d9d9] h-[201px] left-0 top-[145px] w-[238px]" />
          <div className="absolute bg-[#d9d9d9] h-[201px] left-[274px] top-[145px] w-[230px]" />
          <div className="absolute bg-[#d9d9d9] h-[201px] left-[540px] top-[145px] w-[230px]" />
          <div className="absolute bg-[#d9d9d9] h-[201px] left-[806px] top-[145px] w-[230px]" />
          <div className="absolute bg-[#d9d9d9] h-[201px] left-[1072px] top-[145px] w-[230px]" />
        </>
      )}
    </button>
  );
...
function QuickAccessBlock() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Quick Access Block">
      <Footer />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[72px] items-center left-[-9px] top-[589px] w-[1530px]">
      <UsefulLinks className="block cursor-pointer drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] h-[110px] relative shrink-0 w-[1300px]" />
      <QuickAccessBlock />
    </div>
  );
}
...
function Hero() {
  return (
    <div className="absolute contents left-[-0.5px] top-[104.12px]" data-name="Hero">
      ...
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Refrigerator_Deluxe:ExtraBold',sans-serif] h-[116.55px] leading-[normal] left-[calc(50%+0.53px)] not-italic text-[96px] text-center text-white top-[259.4px] tracking-[4.8px] uppercase w-[880.95px]">onboarding</p>
    </div>
  );
}
...
export default function Onboarding() {
  return (
    <div className="bg-white relative size-full" data-name="onboarding">
      <Frame />
      <Hero />
      <NavBar className="absolute bottom-0 h-[912px] left-0 pointer-events-none top-0" />
    </div>
  );
}